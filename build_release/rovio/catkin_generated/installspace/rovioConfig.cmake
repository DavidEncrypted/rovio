...
if("FALSE" STREQUAL "TRUE")
  set(rovio_SOURCE_PREFIX /home/ws/src/rovio)
  set(rovio_DEVEL_PREFIX /home/ws/devel_release/.private/rovio)
  set(rovio_INSTALL_PREFIX "")
  set(rovio_PREFIX ${rovio_DEVEL_PREFIX})
else()
  set(rovio_SOURCE_PREFIX "")
  set(rovio_DEVEL_PREFIX "")
  set(rovio_INSTALL_PREFIX /home/ws/install_release)
...
if(NOT "include;/home/ws/devel_release/include;/opt/ros/noetic/include;/opt/ros/noetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include/eigen3;/usr/include;/usr/include/opencv4 " STREQUAL " ")
  set(rovio_INCLUDE_DIRS "")
  set(_include_dirs "include;/home/ws/devel_release/include;/opt/ros/noetic/include;/opt/ros/noetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include/eigen3;/usr/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rovio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rovio_NUM_DUMMY_TARGETS)
      set(rovio_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rovio::wrapped-linker-option${rovio_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rovio_NUM_DUMMY_TARGETS "${rovio_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rovio::wrapped-linker-option${rovio_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rovio_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND rovio_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rovio_EXPORTED_TARGETS ${${rovio_dep}_EXPORTED_TARGETS})
endforeach()
