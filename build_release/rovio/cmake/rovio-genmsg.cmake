...
get_filename_component(_filename "/home/ws/src/rovio/srv/SrvResetToPose.srv" NAME_WE)
add_custom_target(_rovio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rovio" "/home/ws/src/rovio/srv/SrvResetToPose.srv" "geometry_msgs/Quaternion:geometry_msgs/Point:std_msgs/Empty:geometry_msgs/Pose"
)
...
_generate_srv_cpp(rovio
  "/home/ws/src/rovio/srv/SrvResetToPose.srv"
  "${MSG_I_FLAGS}"
  "/opt/ros/noetic/share/geometry_msgs/cmake/../msg/Quaternion.msg;/opt/ros/noetic/share/geometry_msgs/cmake/../msg/Point.msg;/opt/ros/noetic/share/std_msgs/cmake/../msg/Empty.msg;/opt/ros/noetic/share/geometry_msgs/cmake/../msg/Pose.msg"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rovio)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rovio\")")
  # install generated code
  install(
