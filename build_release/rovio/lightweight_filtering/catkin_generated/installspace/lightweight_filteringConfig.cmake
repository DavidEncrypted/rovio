...
if("FALSE" STREQUAL "TRUE")
  set(lightweight_filtering_SOURCE_PREFIX /home/ws/src/rovio/lightweight_filtering)
  set(lightweight_filtering_DEVEL_PREFIX /home/ws/devel_release/.private/rovio)
  ...
  set(lightweight_filtering_INSTALL_PREFIX /home/ws/install_release)
...
if(NOT "include;/home/ws/devel_release/include;/usr/include/eigen3 " STREQUAL " ")
  set(lightweight_filtering_INCLUDE_DIRS "")
  set(_include_dirs "include;/home/ws/devel_release/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lightweight_filtering' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT lightweight_filtering_NUM_DUMMY_TARGETS)
      set(lightweight_filtering_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lightweight_filtering::wrapped-linker-option${lightweight_filtering_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lightweight_filtering_NUM_DUMMY_TARGETS "${lightweight_filtering_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lightweight_filtering::wrapped-linker-option${lightweight_filtering_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lightweight_filtering_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND lightweight_filtering_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ws/install_release/lib;/home/ws/devel_release/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(lightweight_filtering_EXPORTED_TARGETS ${${lightweight_filtering_dep}_EXPORTED_TARGETS})
endforeach()
